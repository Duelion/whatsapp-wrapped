...
def generate_static_html(
    ...
    async def _generate_static() -> Path:
        ...
        async with async_playwright() as p:
            ...
            # Timeout is set high (2 minutes) for big groups with many members/charts
...
Examples:
  ...
  whatsapp-wrapped chat.zip --quiet
    ...
    parser.add_argument(
        "--name",
        help="Custom name for the report file AND the main title displayed in the report (default: chat filename)",
        default=None,
    )
