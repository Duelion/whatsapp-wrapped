...
| 📅 **Calendar Heatmaps** | 💬 **Message Analysis** | 🔒 **100% Private** |
| Year-at-a-glance activity view | Word clouds & response times | All processing stays on your device |
...
Run `uv run whatsapp-wrapped --help` for all options (year filter, PDF export, and more).
